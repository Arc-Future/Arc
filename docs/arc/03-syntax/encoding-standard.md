...
本节是 Arc **表面语法与命名**的权威对照表：明确采纳 C# 惯例、拒绝 Rust 渗透。实现与文档冲突时，以本节 + [04 词法与语法](lexicon-syntax.md) 为准。
...
| 文档 | 关系 |
|------|------|
| [04 词法与语法](lexicon-syntax.md) | 具体产生式与示例 |
| [05 类型系统](../04-types/type-system.md) | 类型与命名规范 |
| [07 对象模型](../06-objects/object-model.md) | 扩展方法、索引器、属性 |
