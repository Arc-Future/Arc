...
- [构建与运行](build-run.md) 了解 `arc build` / `arc run` 的完整用法与项目目录约定
- [结构化诊断](../12-advanced/diagnostics.md) 了解如何阅读与消费编译诊断
- [编译器 CLI](../10-toolchain/compiler-cli.md) 查看 `arc` 全部子命令与参数
