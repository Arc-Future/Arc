...
Harness 分两层：**基座**（`Arc.Agent.Harness`）与**领域**（首域 `Arc.Agent.Harness.Coding`）。基座核心是 **`AIRfc`**——小型项目管理 / 需求本尊运行时（跨任务、跨版本）；计划面直接复用 `AIPlan`（宿主 [038 §12](https://github.com/Arc-Future/Arc/blob/main/docs/rfc/038-ai-host.md)），与 `AITool` 共用冲突织物（[038 §13](https://github.com/Arc-Future/Arc/blob/main/docs/rfc/038-ai-host.md) · [conflict-fabric](https://github.com/Arc-Future/Arc/blob/main/docs/rfc/043-harness/references/conflict-fabric.md)）。
...
设计权威：[RFC 043](https://github.com/Arc-Future/Arc/blob/main/docs/rfc/043-harness.md) · [AIRfc](https://github.com/Arc-Future/Arc/blob/main/docs/rfc/043-harness/references/airfc.md) · [冲突织物](https://github.com/Arc-Future/Arc/blob/main/docs/rfc/043-harness/references/conflict-fabric.md) · [llm-gates](https://github.com/Arc-Future/Arc/blob/main/docs/rfc/043-harness/references/llm-gates.md) · [api-sketch](https://github.com/Arc-Future/Arc/blob/main/docs/rfc/043-harness/references/api-sketch.md)。
...
- **工具注册机制**（显式注册 / 静态构造器）见规范章 [RFC 037 §6](https://github.com/Arc-Future/Arc/blob/main/docs/rfc/037-ui.md)；本册只讲 `[AITool]` 的使用方式。
