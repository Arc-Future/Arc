// RFC 038: DeepSeek API 错误响应 DTO（internal，仅服务 Provider 反序列化）。
namespace Arc.Agent.DeepSeek;
using Arc.Text.Json;

/// <summary>
/// DeepSeek 错误响应：{"error":{"message":"...","type":"..."}}。
/// </summary>
internal class DeepSeekError : IJsonDeserializable {
    public string Message;
    public string Type;

    public DeepSeekError() {
        this.Message = "";
        this.Type = "";
    }
